...
/// }
///
/// #[agave_event_system::event(max_serialized_size = 1024)]
/// struct Message {
///     contents: String,
/// }
/// ```
...
fn event_impl(
    ...
    if !input.generics.params.is_empty() {
        return Err(syn::Error::new_spanned(
            &input.generics,
            "Event cannot be derived for generic types on stable Rust; implement it by hand \
             instead (see `agave_event_system::Event::QueueCell`)",
        ));
    }
